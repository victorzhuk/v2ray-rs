    ...
    vec![
        Preset {
            ...
            rules: vec![
                ...
                PresetRule {
                    match_condition: RuleMatch::IpCidr {
                        cidr: "169.254.0.0/16".parse().unwrap(),
                    },
                    action: RuleAction::Direct,
                },
                PresetRule {
                    match_condition: RuleMatch::IpCidr {
                        cidr: "224.0.0.0/4".parse().unwrap(),
                    },
                    action: RuleAction::Direct,
                },
                PresetRule {
                    match_condition: RuleMatch::IpCidr {
                        cidr: "255.255.255.255/32".parse().unwrap(),
                    },
                    action: RuleAction::Direct,
                },
                PresetRule {
                ...
                PresetRule {
                    match_condition: RuleMatch::GeoSite {
                        category: "category-gov-ru".into(),
                    },
                    action: RuleAction::Direct,
                },
                PresetRule {
                    match_condition: RuleMatch::GeoSite {
                        category: "category-media-ru".into(),
                    },
                    action: RuleAction::Direct,
                },
                PresetRule {
                    match_condition: RuleMatch::GeoSite {
                        category: "category-retail-ru".into(),
                    },
                    action: RuleAction::Direct,
                },
                PresetRule {
                    match_condition: RuleMatch::GeoSite {
                        category: "mailru".into(),
                    },
                    action: RuleAction::Direct,
                },
                PresetRule {
                    match_condition: RuleMatch::GeoSite {
                        category: "mailru-group".into(),
                    },
                    action: RuleAction::Direct,
                },
                PresetRule {
                    match_condition: RuleMatch::GeoSite {
                        category: "category-entertainment-ru".into(),
                    },
                    action: RuleAction::Direct,
                },
                PresetRule {
                    match_condition: RuleMatch::GeoSite {
                        category: "category-ecommerce-ru".into(),
                    },
                    action: RuleAction::Direct,
                },
                PresetRule {
                    match_condition: RuleMatch::GeoSite {
                        category: "rutube".into(),
                    },
                    action: RuleAction::Direct,
                },
                PresetRule {
        ...
        Preset {
            ...
            rules: vec![
                ...
                PresetRule {
                    match_condition: RuleMatch::GeoIp {
                        country_code: "NETFLIX".into(),
                    },
                    action: RuleAction::Proxy,
                },
                PresetRule {
                    match_condition: RuleMatch::GeoIp {
                        country_code: "TELEGRAM".into(),
                    },
                    action: RuleAction::Proxy,
                },
                PresetRule {
                    match_condition: RuleMatch::GeoIp {
                        country_code: "TWITTER".into(),
                    },
                    action: RuleAction::Proxy,
                },
                PresetRule {
                    match_condition: RuleMatch::GeoSite {
                        category: "amazon".into(),
                    },
                    action: RuleAction::Proxy,
                },
                PresetRule {
                ...
                PresetRule {
                    match_condition: RuleMatch::GeoSite {
                        category: "aws-cn".into(),
                    },
                    action: RuleAction::Proxy,
                },
                PresetRule {
                    match_condition: RuleMatch::GeoSite {
                        category: "category-ai-!cn".into(),
                    },
                    action: RuleAction::Proxy,
                },
                PresetRule {
                    match_condition: RuleMatch::GeoSite {
                        category: "category-ai-chat-!cn".into(),
                    },
                    action: RuleAction::Proxy,
                },
                PresetRule {
                    match_condition: RuleMatch::GeoSite {
                        category: "deezer".into(),
                    },
                    action: RuleAction::Proxy,
                },
                PresetRule {
                    match_condition: RuleMatch::GeoSite {
                        category: "duckduckgo".into(),
                    },
                    action: RuleAction::Proxy,
                },
                PresetRule {
